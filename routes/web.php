...
Route::get('/Event/TravelerEventCreate',[EventController::class,'TravelerEventCreate'])->name('admin.Event.Traveler.CreateEvent');
Route::post('/Event/AddTravelersEvent/storeTravelerEvent',[EventController::class,'posttravelerEvent'])->name('admin.traveler.EventTraveler');
Route::get('/Event/TravelerEventList',[EventController::class,'TravelerEventList'])->name('admin.Event.Traveler.EventList');
