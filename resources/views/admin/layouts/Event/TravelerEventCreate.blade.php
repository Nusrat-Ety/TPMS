            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Traveler Event Create</h3>
<form action="{{route('admin.traveler.EventTraveler')}}" method="POST">
  @csrf
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationDefault01">Traveler Event name</label>
      <input name="name" class="form-control" id="validationDefault01" placeholder="Event name"  required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">Traveler Event description</label>
  ...
  <div class="form-row">
    ...
    <div class="col-md-3 mb-3">
      <label for="validationDefault05">Traveler Name</label>
      <select name="traveler_name" class="form-control" id="validationDefault05" placeholder="Traveler name" required>
                @foreach ($travelars as $travelar)
                    <option value="{{$travelar->id}}">{{$travelar->Fname}}</option>
                @endforeach
