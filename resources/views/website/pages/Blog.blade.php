            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container" >
                        ...
                        <section id="home" class="" style="display:flex; align-items:center; background-size:cover; background-position:center;min-height: 402px; background-image: url('/image/darjeeling.jpg')">
			<div class="container">
				<div class="about-us-content">
					<!-- <div class="row">
						...
						<div class="col-sm-0">
							<div class="single-about-us">
                                        ...
                                        <h3 style="text-align:center; text-align:center; margin-top: 148px;color: white; font-size: 50px;">Limitations Of Liability</h3>
                   ...
                   <div style="padding-left: 25px; padding-right: 25px; margin-bottom: 70px;">
                    <div class="text-container" style="margin-top: 30px;">
                        <h3 style="padding-bottom: 15px;">Terms And Conditions</h3>
